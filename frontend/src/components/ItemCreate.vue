        ...
        <form @submit.prevent="handleSubmit" class="create-form">
          ...
          <div class="form-group">
            ...
            <textarea
              ...
              class="form-textarea"
              placeholder="请输入条目介绍（可选）"
              rows="4"
              maxlength="1000"
              @blur="validateDescription"
            ></textarea>
            <span class="form-hint">{{ formData.description.length }}/1000 字符</span>
...
const validateDescription = () => {
  ...
  if (formData.description.length > 1000) {
    errors.description = '介绍长度不能超过1000个字符'
    return false
  }
  return true
}
...
const validateForm = () => {
  ...
  return isTitleValid && isDescriptionValid && isImageValid
}
