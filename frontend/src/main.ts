...
const routes =[
    ...
    {path:"/personal/own",name: 'ownPS',component:PersonalSpace},
    {path:"/anime/:id",component:AnimeDetailView},
    {path:"/login",component:Login},
    {path:"/register",component:Register},
    {path:"/forgot-password", component: ForgotPassword },
    { path: '/change-password', name: 'ChangePassword', component: ChangePassword },
    { path: '/change-contact',  name: 'ChangeContact',  component: ChangeContact },
    // 条目相关路由
    ...
    //从推荐页访问他人个人空间路由
    {path:"/personal/others/:id",name: 'otherPS',component:PersonalSpace,},
    // 搜索路由
    {path:"/search", component: Search},
    // 管理后台路由
    {path:"/admin/reports", component: ReportManagement},
